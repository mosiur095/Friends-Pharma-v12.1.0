...
import com.friendspharma.app.features.presentation.pathao_courier.DeliveryType

@Composable
fun DeliveryTypeDialog(
    title: String,
    onDismiss: () -> Unit,
    onSelected: (DeliveryType) -> Unit,
    types: List<DeliveryType> = listOf<DeliveryType>(DeliveryType("Normal Delivery", 48), DeliveryType("On Demand Delivery", 12)),
